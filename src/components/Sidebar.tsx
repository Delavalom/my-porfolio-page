...
const SidebarContainer: FC<SidebarContainerProps> = ({ children, isOpen }) => {
  return (
    <aside
      ...
      } dark:text-slate-200 3xl:w-80 z-30 flex h-full w-3/4 flex-none transform flex-col overflow-y-auto border-r border-gray-150 bg-white pb-10 transition duration-200 ease-in-out dark:border-gray-800 dark:bg-gray-900 sm:w-1/2 sm:pb-0 md:w-1/3 lg:relative lg:z-auto lg:w-56 lg:translate-x-0 2xl:w-72`}
    >
      {children}
    </aside>
  );
