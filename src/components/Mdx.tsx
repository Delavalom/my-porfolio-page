...
const components = {
	...
	blockquote: ({ className, ...props }: HtmlHTMLAttributes<HTMLQuoteElement>) => (
		<blockquote
			className={cn(
	...
	hr: ({ ...props }: HtmlHTMLAttributes<HTMLHRElement>) => (
		<hr {...props} className="my-4 border-zinc-200 md:my-8" />
	),
	...
	th: ({ className, ...props }: HtmlHTMLAttributes<HTMLTableHeaderCellElement>) => (
		<th
			className={cn(
	...
	td: ({ className, ...props }: HtmlHTMLAttributes<HTMLTableDataCellElement>) => (
		<td
			className={cn(
